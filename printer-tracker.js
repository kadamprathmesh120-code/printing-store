...
function markOrderPrinted(orderId) {
  ...
  try {
    ...
    // Document files are retained for Admin Preview and cleaned up by scheduled auto-cleanup (or manual delete).
  } catch (e) {
    console.error('Error updating printed status in DB:', e.message);
  }
}
